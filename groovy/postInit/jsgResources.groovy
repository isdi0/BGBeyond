...
mods.thermalexpansion.transposerfill.add(4000, item('libvulpes:productingot', 7), fluid('naquadah_molten_refined') * 144, item('jsg:naquadah_alloy') * 2, 100)
...
mods.advancedrocketry.precisionassembler.recipeBuilder()
    .input(item('advancedrocketry:ic', 3), item('minecraft:redstone') * 8)
    .fluidInput(fluid('silicon_molten_white') * 288)
    .output(item('jsg:circuit_control_base'))
    .fluidOutput(fluid('silicon_molten_black') * 144)
    .power(100)
    .time(400)
    .register()
